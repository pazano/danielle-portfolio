...
const portfolioImages = [
  {
    ...
    metadata: {
      ...
      description: 'Editorial fashion portrait of model in southern California desert in vintage neutral tone clothing',
      keywords: 'los angeles fashion photographer, los angeles commercial photography, los angeles commercial fashion photographer, los angeles commercial fashion photography, southern california beauty photographer, los angeles portrait photographer, in studio double exposure photography, west la studio photographer, west los angeles portrait photographer, los angeles model photographer, male model studio photoshoot, black male model, black male model los angeles, double exposure black male model, double exposure editorial photography',
    ...
    id: 4,
    metadata: {
      title: 'Ebb & Flow | Oceanside Ethereal Editorial',
      description: 'Editorial fashion portrait of model in southern California Santa Monica Beach wearing high end luxury clothing as the waves serenely crash over the moss covered rocks',
    ...
    id: 5,
    metadata: {
      title: 'Male Beauty | Studio Portraiture',
      description: 'Up close beauty portrait of black male model shot in Los Angeles Studio by Danielle Rouillard',
    ...
    id: 6,
    metadata: {
      title: 'Cool Cool Summer | Beach Fashion Editorial',
      description: 'Editorial fashion portrait of latina model captured in the warm golden hour beach sunset by Los Angeles photographer Danielle Rouillard',
    ...
    metadata: {
      title: 'Ebb & Flow | Oceanside Ethereal Editorial',
      description: 'Editorial fashion portrait of model in southern California Santa Monica Beach wearing high end luxury clothing photographed by Danielle Rouillard',
      keywords: 'black model los angeles fashion photography, santa monica fashion photography, luxury fashion photography, luxury fashion los angeles, luxury fashion photographer, ethereal fashion photographer, los angeles fashion photographer, los angeles commercial photography, los angeles commercial fashion photographer, los angeles commercial fashion photography, southern california beauty photographer, los angeles portrait photographer, in studio double exposure photography, west la studio photographer, west los angeles portrait photographer, los angeles model photographer, female model studio photoshoot, black female model, black woman model los angeles',
    ...
    id: 8,
    metadata: {
      title: 'Neutral Glam | In Studio Beauty Photography',
      description: 'Editorial beauty portrait of latina fashion model shot in Los Angeles, CA by photographer Danielle Rouillard',
    ...
    metadata: {
      title: 'Vintage Desert Neutrals | Los Angeles Fashion Editorial',
      description: 'Editorial up close fashion portrait of model in southern California desert in vintage neutral tone clothing',
    ...
    id: 10,
    metadata: {
      title: 'Desert Summer | Los Angeles Male Fashion Editorial',
      description: 'Editorial fashion portrait of black male model in southern California desert shot on film by Danielle Rouillard',
